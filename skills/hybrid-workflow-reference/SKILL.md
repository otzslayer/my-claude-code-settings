...
| Need | Read |
| --- | --- |
| Routing call is non-obvious; fable vs opus; build carve-out; why sonnet is suspended | `references/scoring.md` (§2·§3·§4) |
