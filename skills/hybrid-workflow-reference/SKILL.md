...
description: Index of the hybrid workflow's deferred reference files — effort scoring and escalation rationale, Implementation Unit granularity, and brainstorming rigor-probe lenses. Use when a routing call is non-obvious, when departing from the coarse-unit or serial-subagent default in ce-plan/ce-work, or when brainstorming product-facing work. Read only the one file this index points to.
---
...
| Departing from the coarse-unit or serial-subagent default | `references/units.md` (§6) |
