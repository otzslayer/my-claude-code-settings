...
**결과는 강제가 아니라 후보다.** 매칭이 놓쳤다 싶은 표기는 따로 물어볼 수 있다.
...
**기록 대상**: Step 4 "기록해 둘 결정 모으기"에서 모은 셋이다. 고유명사, 기술 용어, 그리고 대소문자나 맥락 때문에 판단이 갈렸던 것. 옛 글로서리 후보를 채택한 경우도 여기 포함한다. **그대로 옮기지 말고 재검토해 맥락을 붙이고, 번역값이 부적절하면 고쳐서 넣는다.**
